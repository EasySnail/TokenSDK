...
SWIFT_CLASS("_TtC8TokenSDK6TKJSON")
@interface TKJSON : NSObject
+ (NSString * _Nonnull)jsonStringWithData:(id _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
...
+ (void)testWithDid:(NSString * _Nonnull)did image:(UIImage * _Nonnull)image;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface TokenApi (SWIFT_EXTENSION(TokenSDK))
+ (NSString * _Nullable)lx_tokentm_dataWithDid:(NSString * _Nonnull)did key:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
@end
...
/// \param handler 回调返回data
///
+ (void)chainCallWithDid:(NSString * _Nonnull)did address:(NSString * _Nonnull)address handler:(void (^ _Nonnull)(TKResultData * _Nonnull))handler;
/// <ul>
///   <li>
///     调用合约
///   </li>
...
/// \param handler 回调返回data
///
+ (void)chainInvokeWithDid:(NSString * _Nonnull)did handler:(void (^ _Nonnull)(TKResultData * _Nonnull))handler;
@end
...
/// \param did did
///
+ (void)token_get_backup_dataWithDid:(NSString * _Nonnull)did dataId:(NSString * _Nullable)dataId dataType:(NSString * _Nonnull)dataType handler:(void (^ _Nonnull)(TKResultData * _Nonnull))handler;
@end
...
///   </li>
/// </ul>
+ (void)getHashInfo:(NSString * _Nonnull)hash handler:(void (^ _Nonnull)(TKResultData * _Nonnull))handler;
@end
